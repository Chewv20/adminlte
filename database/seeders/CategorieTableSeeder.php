...
class CategorieTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $category1 -> description = "Categoria basada en deportes";
        ...
        $category3 -> description = "Categoria basada juegos llenos de misterio";
        $category3 -> active = true;
        $category3 -> save();

        $category4 = new Category;
        $category4 -> name = "RPG";
        $category4 -> description = "Categoria basada juegos del rol";
